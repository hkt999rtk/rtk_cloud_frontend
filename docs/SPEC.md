...
| Private Cloud / Deployment | Implemented | `/features/private-cloud`, `/docs/deployment` | Website v1 now compares public evaluation, managed private deployment, and customer-operated private regions with coverage for data ownership, custom domains, regional placement, upgrade path, deployment FAQ, and production-support boundaries. |
