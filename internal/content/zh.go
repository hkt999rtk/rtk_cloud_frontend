...
func zhTWText() map[string]string {
	return map[string]string{
		...
		"home.lede":                                 "透過 Realtek 託管雲端、配網、OTA、裝置營運、App SDK、洞察、Private Cloud 與生態系整合，讓 Realtek 裝置更快進入可營運的連網產品生命週期。",
		...
		"home.deploy.public.body":                   "Realtek 負責建置、託管、維護與平台營運。按實際使用量付費是目前的商業概念；正式費率與計價單位將另行確認。",
...
func zhTWFeatures() map[string]localizedFeature {
	return map[string]localizedFeature{
		...
		"private-cloud": {
			...
			Highlights:  []string{"推薦由 Realtek 建置並維運的託管服務", "依實際使用量付費，不在本頁承諾正式費率", "保留客戶自有 Private Cloud 作為第二選項"},
			Capabilities: []string{
			...
			Sections: []features.FeatureSection{
				{
					...
					Items: []string{
						...
						"客戶依實際服務使用量付費；正式費率與計價單位另行確認，本頁不公布價格承諾。",
			...
			Table: features.FeatureTable{
				...
				Columns: []string{"方案", "營運責任", "商業概念", "適合對象"},
				Rows: []features.FeatureTableRow{
					{Cells: []string{"Realtek 託管服務（推薦）", "由 Realtek 託管、維護與營運。", "依實際使用量付費，正式費率另行確認。", "希望快速導入且不自建雲端維運能力的團隊。"}},
