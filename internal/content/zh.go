...
func zhTWText() map[string]string {
	return map[string]string{
		...
		"privacy.intro":              "第一版網站只收集回覆 Realtek Connect+ 商務詢問與早期評估請求所需的資訊。當 ANALYTICS_ENABLED 為 true 時，也會使用第一方 SQLite analytics 做基本網站量測。",
		...
		"privacy.use.body":           "我們使用提交資料來回覆詢問、規劃產品討論、了解 Realtek Connect+ 服務需求，並保護網站免於 spam 或濫用。第一方 analytics 僅用於了解此網站的粗略流量來源、頁面互動、CTA conversion 與內容成效。",
