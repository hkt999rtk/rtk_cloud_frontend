...
func zhTWText() map[string]string {
	return map[string]string{
		...
		"home.hero.title":                               "Realtek 託管的 IoT 雲端，從裝置上線到持續營運",
		"home.hero.image.alt":                           "Realtek Connect+ 連結裝置、應用程式與營運的雲端平台",
		...
		"home.deploy.private.title":                     "支援 GCP、Azure、AWS 或自建機房，無雲端綁定。",
		"home.deploy.private.body":                      "Realtek Connect+ 私有部署以標準 Container 或 VM 形式運行。無需 Serverless 運行環境，不依賴特定雲端供應商，帶入自有基礎架構即可。",
		...
		"home.core.title":                               "以三個相互銜接的流程營運裝置生命週期。",
