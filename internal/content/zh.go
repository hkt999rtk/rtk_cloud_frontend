...
func zhTWPages() map[string]PageMeta {
	return map[string]PageMeta{
		"home": {
			...
			Description: "Realtek Connect+ 是面向 Realtek 裝置的物聯網雲端平台，提供 Realtek 託管的用量型服務、Private Cloud、配網、OTA、裝置營運、App SDK、洞察與整合能力。",
		},
		"features": {
		...
		"search": {
			Title:       "文件查詢 | Realtek Connect+",
			Description: "針對 Realtek Connect+ 網站文件提出問題，取得以來源文件為依據的回答。",
		},
	}
}
...
func zhTWText() map[string]string {
	return map[string]string{
		...
		"nav.docs":                                      "文件",
		"portal.breadcrumb":                             "導覽路徑",
		"portal.toc":                                    "本頁內容",
		"portal.manual.cta":                             "閱讀開發者手冊",
		"nav.features":                                  "功能",
		"nav.architecture":                              "架構",
		"nav.contact":                                   "聯絡",
		"nav.search":                                    "查詢",
		"nav.menu":                                      "開啟導覽選單",
		"nav.language":                                  "語言",
		"not_found.title":                               "找不到頁面",
		"not_found.description":                         "找不到您要求的 Realtek Connect+ 頁面。",
		"not_found.heading":                             "這個頁面已不在連線範圍內。",
		"not_found.body":                                "連結可能已過期，或頁面已移動。請返回入口網站，繼續探索 Realtek Connect+。",
		"not_found.actions":                             "頁面復原操作",
		"not_found.home":                                "返回首頁",
		"not_found.back":                                "返回上一頁",
		"footer.tagline":                                "面向 Realtek 連網產品的物聯網雲端平台概念網站。",
		"footer.group.platform":                         "平台",
		"footer.group.features":                         "功能服務",
		"footer.group.docs":                             "開發者文件",
		"footer.group.manual":                           "使用手冊",
		"footer.group.company":                          "網站資訊",
		"footer.home":                                   "首頁",
		"footer.docs":                                   "開發者文件",
		"footer.features":                               "功能服務",
		"footer.manual":                                 "使用手冊",
		"footer.search":                                 "文件查詢",
		"footer.sitemap.label":                          "頁尾網站導覽",
		"footer.contact":                                "聯絡我們",
		"footer.privacy":                                "隱私權",
		"search.eyebrow":                                "文件查詢",
		"search.title":                                  "詢問 Realtek Connect+ 文件。",
		"search.body":                                   "透過 OpenAI embeddings 檢索網站文件，並產生以來源文件為依據的回答。如果索引文件沒有涵蓋問題，工具會直接告知查不到。",
		"search.label":                                  "問題",
		"search.placeholder":                            "詢問 OTA、SDK 範例、私有雲部署、配網或平台功能。",
		"search.submit":                                 "查詢文件",
		"search.note":                                   "查詢範圍限制在本網站已索引文件。",
		"search.empty.title":                            "先輸入一個聚焦的產品或文件問題。",
		"search.empty.body":                             "結果會包含回答，以及用來產生回答的來源文件。",
		"search.answer.title":                           "回答",
		"search.sources.title":                          "來源",
		"search.nohit.title":                            "查不到相關文件",
		"search.nohit.body":                             "查不到相關文件。",
		"search.disabled.title":                         "查詢未啟用",
		"search.disabled.body":                          "此環境尚未提供文件索引。",
		"search.invalid.title":                          "請輸入問題",
		"search.invalid.body":                           "最多 500 個字元。",
		"search.loading.title":                          "正在查詢文件",
		"search.loading.body":                           "先檢索來源片段，再產生回答。",
		"search.error.title":                            "查詢暫時無法使用",
		"search.error.body":                             "查詢服務暫時無法使用。",
		"home.eyebrow":                                  "Realtek 託管的物聯網雲端",
		"home.hero.title":                               "Realtek 託管 IoT 雲端，讓裝置上線、持續營運",
		"home.hero.line1":                               "Realtek 託管 IoT 雲端",
		"home.hero.line2":                               "讓裝置上線、持續營運",
		"home.hero.image.alt":                           "去識別化的 Realtek Connect+ 韌體與裝置營運 Portal",
		"home.lede":                                     "以託管配網、安全韌體更新、裝置群營運與完整平台服務，協助連網產品更快進入市場並持續營運。",
		"home.cta.primary":                              "立即開始使用",
		"home.cta.secondary":                            "查看方案與額度",
		"home.contact.cta":                              "聯絡業務",
		"home.benefits.aria":                            "服務效益",
		"home.benefit.managed":                          "由 Realtek 建置與維運",
		"home.benefit.usage":                            "依實際使用量彈性付費",
		"home.benefit.login":                            "可直接登入開始使用",
		...
		"home.arch.title":                               "從裝置到日常營運，一條完整連接的路徑。",
		...
		"home.deploy.eyebrow":                           "雲端營運模式",
		"home.deploy.title":                             "由 Realtek 託管營運，或部署在客戶自己的環境。",
		"home.deploy.public":                            "推薦方案 · Realtek 託管服務",
		"home.deploy.public.title":                      "使用多少，支付多少。",
		"home.deploy.public.body":                       "由 Realtek 建置、託管與維運，客戶依實際使用量彈性付費。詳細服務方案請洽詢 Realtek 團隊。",
		"home.deploy.image.alt":                         "去識別化的託管服務帳務與營運 Portal",
		"home.deploy.docs":                              "查看方案與額度",
		"home.deploy.private":                           "私有商用雲",
		"home.deploy.private.title":                     "專屬基礎架構需求，可規劃 Private Cloud。",
		"home.deploy.private.body":                      "當產品需要自有基礎架構、資料位置或治理邊界時，Realtek 團隊會依需求共同規劃專屬部署。",
		"home.deploy.discuss":                           "討論私有雲",
		"home.trust.eyebrow":                            "企業級基礎",
		"home.trust.title":                              "為連網產品打造的雲端營運路徑。",
		"home.trust.managed.title":                      "Realtek 建置與維運",
		"home.trust.managed.body":                       "由 Realtek 負責平台建置及持續營運。",
		"home.trust.security.title":                     "裝置身分與 PKI",
		"home.trust.security.body":                      "以安全基礎串連裝置身分與雲端存取。",
		"home.trust.flexible.title":                     "託管延伸至 Private Cloud",
		"home.trust.flexible.body":                      "需要專屬環境時，可延伸相同產品路徑。",
		"home.core.eyebrow":                             "核心能力",
		"home.core.title":                               "用三個連續流程，營運裝置生命週期。",
		"home.core.title.line1":                         "用三個連續流程，",
		"home.core.title.line2":                         "營運裝置生命週期。",
		"home.core.lede":                                "從裝置上線、韌體發布到日常健康管理，使用一致的視覺營運模型。",
		"home.core.tabs.aria":                           "核心平台能力",
		"home.core.provision.title":                     "Provision 配網",
		"home.core.provision.body":                      "透過 QR Code、Bluetooth 或 Wi-Fi 引導產品完成配網，並安全註冊至雲端及建立裝置身分。",
		"home.core.provision.image.alt":                 "從 QR Code 與無線配網到安全雲端註冊的流程",
		"home.core.ota.title":                           "OTA 韌體更新",
		"home.core.ota.body":                            "安排韌體版本、控制分批發布群組、掌握進度，並預備安全的回復路徑。",
		"home.core.ota.image.alt":                       "韌體版本與分批發布控制中心",
		"home.core.fleet.title":                         "裝置群管理",
		"home.core.fleet.body":                          "整理裝置群組、檢視健康度與告警，並對裝置群執行一致的批次操作。",
		"home.core.fleet.image.alt":                     "包含群組、健康度、告警與操作的裝置群營運畫面",
		"home.capabilities.lede":                        "支援服務串連裝置軟體、雲端營運、應用程式與企業整合。",
		"home.arch.aria":                                "由裝置 SDK 經安全雲端到應用程式與儀表板的平台流程",
		"home.capability.app.title":                     "App SDK",
		"home.capability.app.body":                      "提供配網、控制與帳戶體驗所需的參考 App 與 SDK 路徑。",
		"home.capability.video.title":                   "Video Cloud",
		"home.capability.video.body":                    "將即時影像與裝置體驗連接至託管雲端流程。",
		"home.capability.security.title":                "安全",
		"home.capability.security.body":                 "涵蓋裝置身分、憑證、存取控制與可稽核營運。",
		"home.capability.insights.title":                "洞察",
		"home.capability.insights.body":                 "將裝置訊號轉化為健康度及產品營運可視性。",
		"home.capability.users.title":                   "使用者管理",
		"home.capability.users.body":                    "管理帳戶、裝置關聯、分享與支援流程。",
		"home.capability.integrations.title":            "整合",
		"home.capability.integrations.body":             "透過 API、事件及生態系服務連接產品營運。",
		...
		"home.docs.body":                                "在同一入口查找平台概念、整合指南、API 參考與 SDK 範例。",
		"home.docs.cta":                                 "前往開發者文件",
		"home.docs.open":                                "開啟章節",
		...
		"home.cta.eyebrow":                              "開始產品旅程",
		"home.cta.title":                                "使用 Realtek Connect+，讓下一個連網產品上線。",
		"home.cta.body":                                 "立即登入開始使用，或聯絡 Realtek 團隊討論託管及 Private Cloud 方案。",
		"features.eyebrow":                              "功能",
		...
		"docs.static.title":                             "SDK 參考資料",
		"docs.static.body":                              "透過開發者手冊查閱 SDK 套件、整合指南與 API 參考資料。",
		"doc.back":                                      "返回文件",
		"doc.discuss":                                   "討論實作",
		"doc.coverage":                                  "涵蓋範圍",
		...
		"sdk.downloads.eyebrow":                         "SDK 下載",
		"sdk.downloads.title":                           "下載最新版 Realtek Connect+ Cloud SDK。",
		"sdk.downloads.body":                            "公開評估版本",
		"sdk.downloads.accept":                          "我同意",
		"sdk.downloads.terms":                           "SDK 評估條款",
		"sdk.downloads.package":                         "下載套件",
		"sdk.downloads.bundle":                          "下載完整套件包",
		"sdk.downloads.latest":                          "僅顯示最新且已驗證的版本",
		"sdk.downloads.unsigned":                        "評估產物尚未簽署，下載後請驗證 SHA-256",
		"contact.eyebrow":                               "聯絡",
		"contact.title":                                 "登記 Realtek Connect+ 評估需求。",
		"contact.body":                                  "告訴我們你的產品團隊最關注哪一項服務。Realtek Connect+ 團隊會審閱需求，並與你聯繫合適的後續步驟。",
		"contact.context.eyebrow":                       "早期評估",
		"contact.context.title":                         "面向物聯網產品規劃、Realtek 託管服務與 Private Cloud 評估。",
		"contact.context.body":                          "可用此表單討論 Realtek 託管服務、配網、OTA、裝置群管理、App SDK、洞察、Private Cloud 或整合需求。",
		"contact.thanks":                                "謝謝",
		...
		"contact.company":                               "公司",
		"contact.email":                                 "Email",
		"contact.interest":                              "詢問類型",
		"contact.select":                                "選擇詢問類型",
		"contact.interest.option.evaluation-access":     "評估方案（免費試用註冊或申請放寬額度）",
		"contact.interest.option.commercial-deployment": "商業部署（託管服務、Private Cloud、報價、簽約）",
		"contact.interest.option.partnership":           "合作夥伴或商業開發",
		"contact.interest.option.technical-question":    "技術問題（現有客戶或評估中）",
		"contact.interest.option.other":                 "其他",
		"contact.message":                               "訊息",
		"contact.submit":                                "送出需求",
		...
		"privacy.intro":                                 "第一版網站只收集回覆 Realtek Connect+ 商務詢問與早期評估請求所需的資訊。當 ANALYTICS_ENABLED=true 時，也會使用第一方 SQLite analytics 做基本網站量測。當文件查詢啟用時，會使用 OpenAI 產生 query embeddings，並生成以來源文件為依據的回答。",
		"privacy.data.title":                            "我們收集的資料",
		"privacy.data.body":                             "聯絡表單可能收集姓名、公司、Email、關注服務與選填訊息。Analytics event rows 僅限 page_view、click_cta、scroll milestone 與 engaged-duration events、canonical page 或 CTA keys、必要時的粗略 scroll percent 或 engagement duration、referrer origin only，以及短期 ephemeral session id。不使用 cookies、localStorage。Analytics 不收集姓名、Email、公司、表單訊息、raw IP addresses、full referrer URLs 或 account identifiers，無法可靠地將單筆 raw analytics row 對應到特定個人，analytics 記錄仍可能屬於個人資料。",
		"privacy.use.title":                             "資料使用方式",
		"privacy.use.body":                              "我們使用提交資料來回覆詢問、規劃產品討論、了解 Realtek Connect+ 服務需求，並保護網站免於 spam 或濫用。當 ANALYTICS_ENABLED=true 時，第一方 SQLite analytics 僅用於了解此網站的粗略流量來源、頁面互動、網站效能、CTA conversion、scroll milestone 與 engaged-duration events、engagement duration、內容成效、產品行銷改善與服務品質觀察。",
		"privacy.retention.title":                       "保存期限",
		"privacy.retention.body":                        "網站 leads 預期最多保存 24 個月，除非仍有進行中的商務討論或必要營運紀錄需要更長期間。Raw analytics event rows 預設透過 ANALYTICS_RETENTION_DAYS 保存 90 天。aggregate metrics 若有實作，可保留更久，但必須獨立限定並另行記錄。",
