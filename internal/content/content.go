...
func enText() map[string]string {
	return map[string]string{
		...
		"home.hero.title":                               "A Realtek-managed IoT cloud, from device onboarding to continuous operations.",
		"home.hero.image.alt":                           "Realtek Connect+ cloud platform connecting devices, applications, and operations",
		...
		"home.core.title":                               "Operate the device lifecycle with three connected workflows.",
