...
func enText() map[string]string {
	return map[string]string{
		...
		"home.lede":                                 "Bring Realtek-based devices online with a Realtek-managed cloud service, provisioning, OTA, fleet operations, app SDKs, insights, private cloud options, and ecosystem integrations.",
		...
		"home.deploy.public.body":                   "Realtek handles setup, hosting, maintenance, and platform operations. Usage-based pricing is the commercial concept; final rates and billing units are confirmed separately.",
