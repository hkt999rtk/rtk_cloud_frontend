...
func enText() map[string]string {
	return map[string]string{
		...
		"privacy.use.body":                              "We use submitted information to respond to inquiries, plan product discussions, understand interest in Realtek Connect+ services, and protect the website from spam or abuse. First-party SQLite analytics is used only when `ANALYTICS_ENABLED=true` to understand coarse traffic source, page engagement, CTA conversion, and content effectiveness for this website.",
