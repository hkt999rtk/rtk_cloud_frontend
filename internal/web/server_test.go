	...
	tests := []struct {
	...
	}{
		{
			...
			snippets: []string{
				...
				"click_cta",
				"scroll milestone",
				"engaged-duration events",
				"engagement duration",
				"referrer origin only",
				"ephemeral session id",
				"does not use cookies, localStorage",
		...
		},
		{
			...
			snippets: []string{
				...
				"Dev 與 Staging 可載入設定的 Google Analytics 4 標籤",
		...
		},
		{
			...
			snippets: []string{
				...
				"Dev 与 Staging 可加载设置的 Google Analytics 4 标签",
