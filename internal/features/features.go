...
func All() []Feature {
	return []Feature{
		...
		},
		{
			...
			Highlights:   []string{"VM/container deployment on GCP, Azure, AWS, or on-premises — no cloud lock-in", "Data ownership and regional placement under your infrastructure policy", "Commercial onboarding, upgrade path, and deployment support expectations"},
			...
			Table: FeatureTable{
				...
				Columns: []string{"Model", "Infrastructure", "What teams get", "Best fit"},
				Rows: []FeatureTableRow{
					{Cells: []string{"Public evaluation", "Shared environment hosted by Realtek.", "Fast access to core platform flows without committing to a customer-specific operating boundary.", "Early evaluations, internal validation, and short proof-of-concept cycles."}},
					{Cells: []string{"Managed private deployment", "Container/VM on customer-selected cloud (GCP, Azure, AWS) or on-premises, operated with agreed support windows.", "Tenant isolation, custom domain options, regional placement, and a production support model.", "Teams that want private deployment outcomes without owning the day-to-day platform operations stack."}},
					{Cells: []string{"Customer-operated private region", "Customer-owned container/VM infrastructure — any cloud or data center — with coordinated release and upgrade planning.", "Maximum control over residency, access policies, and environment-level change management.", "Products with strict enterprise governance, regulated data boundaries, or multi-cloud / on-prem mandates."}},
				},
			},
		},
		{
