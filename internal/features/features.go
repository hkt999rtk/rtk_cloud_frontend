	...
	return []Feature{
		{
			...
			ImagePath:   "/static/assets/portal-fleet-onboarding-promotional-v1.webp", ImageAlt: "Fleet onboarding workspace for Northstar Camera Pro devices",
		...
		marketingFeature("fleet-management", "Fleet management", "fleet", "Keep every device fleet organized.", "Bring devices, groups, health signals, alerts, and coordinated actions into one operating view.", "Realtek Connect+ Fleet Management gives operations teams a practical way to organize connected products, identify devices that need attention, and coordinate routine actions across groups.", "/static/assets/portal-fleet-management-promotional-v1.webp", "Fleet device management workspace for Northstar Devices", []string{"Organize devices into useful groups", "Review health and alerts in one place", "Coordinate actions across the fleet"}),
...
func cloudPlansFeature() Feature {
	return Feature{
		...
		ImagePath:   "/static/assets/feature-cloud-operating-models-promotional-v1.webp", ImageAlt: "Realtek Managed Cloud and Private Cloud operating models",
