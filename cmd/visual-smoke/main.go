	...
	targets := []pageTarget{
		{
			...
			imageSelector:    ".hero-product-frame img",
			expectedHeading:  "Realtek-managed IoT cloudBring devices online. Keep operations moving.",
			expectedTitle:    "Realtek Connect+ | IoT Cloud Platform",
			expectedBodyText: "Built and operated by Realtek",
		},
		{
			name:             "home-zh-tw",
			path:             "/zh-tw/",
			headingSelector:  ".hero h1",
			imageSelector:    ".hero-product-frame img",
			expectedHeading:  "Realtek 託管 IoT 雲端讓裝置上線、持續營運",
			expectedTitle:    "Realtek Connect+ | 物聯網雲端平台",
			expectedBodyText: "由 Realtek 建置與維運",
		},
		{
			name:             "home-zh-cn",
			path:             "/zh-cn/",
			headingSelector:  ".hero h1",
			imageSelector:    ".hero-product-frame img",
			expectedHeading:  "Realtek 托管 IoT 云端让装置上线、持续营运",
			expectedTitle:    "Realtek Connect+ | 物联网云端平台",
			expectedBodyText: "由 Realtek 建置与维运",
		},
		{
			name:             "feature-zh-tw",
		...
		},
		{
			...
			expectedBodyText: "Realtek Connect+ Video Cloud supports",
		},
		{
			...
			expectedHeading:  "Video Cloud",
			expectedTitle:    "Video Cloud | Realtek Connect+",
			expectedBodyText: "Realtek Connect+ Video Cloud 協助",
		},
		{
			name:             "manual-en",
