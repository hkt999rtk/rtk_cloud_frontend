	...
	targets := []pageTarget{
		{
			...
			expectedHeading:  "A Realtek-managed IoT cloud, from device onboarding to continuous operations.",
		...
		},
		{
			...
			headingSelector:  ".hero h1",
			imageSelector:    ".hero-visual img",
			expectedHeading:  "Realtek 託管的 IoT 雲端，從裝置上線到持續營運",
		...
		},
		{
			...
			headingSelector:  ".hero h1",
			imageSelector:    ".hero-visual img",
			expectedHeading:  "Realtek 托管的 IoT 云端，从装置上线到持续营运",
